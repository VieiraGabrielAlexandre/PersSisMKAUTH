...
(function (a) {
	...
	var bo = function (b) {
			if (a.vml) {
				...
				i.title = "Raphaeel Colour Picker", i.style.display = "none", h.doc.body.appendChild(i), bo = bv(function (a) {
					i.style.color = a;
	...
	a.findDotsAtSegment = function (a, b, c, d, e, f, g, h, i) {
		...
		return function () {
			eve("raphael.log", null, "Raphaeel: you are calling to method “" + a + "” of removed object", a)
		}
	};
...
function (a) {
	var b = "hasOwnProperty",
		...
		p = {};
	a.toString = function () {
		return "Your browser supports SVG.\nYou are running Raphaeel " + this.version
	};
	var q = function (d, e) {
			if (e) {
	...
	z.prototype = A, A.constructor = z, a._engine.path = function (a, b) {
		...
		this.bottom = this.top = null, (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with Raphaeel " + a.version)), b.appendChild(this.desc), b.appendChild(this.defs = q("defs"))
...
/* Raphael PIE - Charting library, based on Raphael */
