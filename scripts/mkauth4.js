...
// ABRE JANELA POPUP DO FORM ----------------------------------------------------------------------
function abreJanela(width, height, nameFrame) {
...
function retira_acento(objResp) {
	var varString = new String(objResp.value);
	var stringAcentos = new String('àâêôûãõáéíóúçüÀÂÊÔÛÃÕÁÉÍÓÚÇ Ü"');
	var stringSemAcento = new String('aaeouaoaeioucuAAEOUAOAEIOUC_U_');
...
window.open("mapa_get." + servidor + ".php?retorno=" + callback, "mpg_popup", "toolbar=0, location=0, directories=0, status=1, menubar=0, scrollbars=1, resizable=0, screenX=0, screenY=0, left=0, top=0, width=" + width + ", height=" + height);
return true;
}
